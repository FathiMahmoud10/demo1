        ...
        {showSimplifiedInvoice && (
          ...
          >
            ...
            >
              ...
              <div className="text-center space-y-4 font-mono text-sm" dir={direction}>
            ...
            >
              <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                ...
                <h2 className="text-lg font-bold text-primary flex items-center gap-2">
                  {t('view_payments_ref').replace('{ref}', showPaymentsModal.refNo)}
                </h2>
              </div>
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="p-3">
                        <div className="flex items-center justify-center gap-2 text-gray-600">
                          <button className="hover:text-primary"><Trash2 size={16} /></button>
                          <button className="hover:text-blue-600"><Edit2 size={16} /></button>
                          <button className="hover:text-blue-600"><Mail size={16} /></button>
                          <button className="hover:text-primary"><FileText size={16} /></button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
          ...
          >
            ...
            >
              <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                ...
                <h2 className="text-lg font-bold text-primary">{t('add_payment')}</h2>
              </div>
            ...
            >
              <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-lg font-bold text-primary">{t('store_bond')}</h2>
                </div>
              </div>
          ...
          >
            ...
            >
              <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                ...
                <h2 className="text-lg font-bold text-primary">{t('edit_delivery')}</h2>
              </div>
